...
export default function Right() {
    ...
    useEffect(() => {
        axios.get(`https://api.github.com/users/vinimachad/repos`).then(res => setData(res.data));
    }, [])
    console.log(data);
    return (
        <div id="right">
            ...
            <div className="experience">
                ...
                <div className="hidden-proj">
                    <div className="scroll-proj">
                        {data.map(project => project.name === 'vinimachad' || project.name === 'portifolio-pessoal' ? '' : (<div className="box-proj">
                            ...
                            <div className="content-proj">
                                ...
                                <a target="_blank" href={project.html_url}>Acessar repositiorio no GitHub</a>
                            </div>
                        </div>))}
                    </div>
                </div>
